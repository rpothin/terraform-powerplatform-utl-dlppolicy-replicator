...
When an incident does occur, it is important to report it promptly. To report a possible violation, please [open a GitHub issue](https://github.com/rpothin/terraform-powerplatform-module-template/issues/new) or, for sensitive matters that require confidentiality, contact the primary maintainer directly via GitHub at [@rpothin](https://github.com/rpothin).
